...
cucumber_1.defineSupportCode(function ({ Given, When, Then }) {
    Given(/^I am at the students pages$/, () => __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.browser.get("http://localhost:4200/");
        yield expect(protractor_1.browser.getTitle()).to.eventually.equal('TaGui');
        yield protractor_1.$("a[name='alunos']").click();
    }));

    Given(/^I can see the student "([^\"]*)" with CPF "(\d*)" in the students list$/, (name, cpf) => __awaiter(this, void 0, void 0, function* () {
    ...
    When(/^I try to delete the student "([^\"]*)" with CPF "(\d*)"$/, (name, cpf) => __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.$("input[name='namebox']").sendKeys(name);
        yield protractor_1.$("input[name='cpfbox']").sendKeys(cpf);
        yield protractor_1.element(protractor_1.by.buttonText('Deletar')).click();
    }));
    Then(/^I cant see "([^\"]*)" with CPF "(\d*)" in the students list$/, (name, cpf) => __awaiter(this, void 0, void 0, function* () {
        var allalunos = protractor_1.element.all(protractor_1.by.name('alunolist'));
